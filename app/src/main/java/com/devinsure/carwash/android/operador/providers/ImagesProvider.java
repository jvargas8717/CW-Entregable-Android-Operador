...
import com.devinsure.carwash.android.operador.utils.CompressorBitmapImage;
...
public class ImagesProvider {
    ...
    public ImagesProvider(String ref){
        mStorage = FirebaseStorage.getInstance().getReference().child("client_image").child(ref);
    }
